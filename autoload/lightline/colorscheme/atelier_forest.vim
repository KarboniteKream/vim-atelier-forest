...
let s:normal = [ s:base01, s:base0D ]
let s:insert = [ s:base01, s:base0B ]
let s:visual = [ s:base01, s:base09 ]
let s:replace = [ s:base01, s:base08 ]

let s:filename = [ s:base04, s:base01 ]
let s:inactive = [ s:base03, s:base01 ]
let s:info = [ s:base04, s:base01 ]

let s:p = {'normal': {}, 'inactive': {}, 'insert': {}, 'replace': {}, 'visual': {}, 'tabline': {}}

let s:p.normal.left = [ s:normal, s:filename ]
let s:p.insert.left = [ s:insert, s:filename ]
let s:p.visual.left = [ s:visual, s:filename ]
let s:p.replace.left = [ s:replace, s:filename ]
let s:p.inactive.left = [ s:inactive ]

let s:p.normal.middle = [ [ s:base03, s:base01 ] ]
let s:p.inactive.middle = [ [ s:base03, s:base01 ] ]

let s:p.normal.right = [ s:normal, s:info ]
let s:p.insert.right = [ s:insert, s:info ]
let s:p.visual.right = [ s:visual, s:info ]
