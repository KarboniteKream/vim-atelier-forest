...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/atelier_forest.".&background.".sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "atelier_forest"
...
call <sid>hi("Error",         s:gui08, s:gui01, s:cterm08, s:cterm01, "", "")
...
call <sid>hi("WildMenu",      s:gui0A, s:gui01, s:cterm0A, s:cterm01, "", "")
